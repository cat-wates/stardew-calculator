...
public class Controller {
    ...
    @Autowired
    public Controller(PlayerService playerService, FarmService farmService, BalanceService balanceService, CropFactory cropFactory) {
    ...
    public ResponseEntity test(@RequestBody CropSummaryRequest cropSummaryRequest) {
        ...
        if (crop1.isPresent()) {
            ...
            return ResponseEntity.ok(balanceService.getResults(plantedCrop, player));
        } else {
